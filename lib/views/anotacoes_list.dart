...
import 'package:bloco_notas_n3/views/anotacao.dart';
import 'package:flutter/material.dart';

class AnotacoesList extends StatefulWidget {
  @override
  AnotacoesListState createState() {
    return new AnotacoesListState();
  }
}
                          ...
                          child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  _AnotacaoTexto(anotacoes[index]['conteudo'])
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => Anotacao(AnotacaoModo.Nova, null)));
        },
