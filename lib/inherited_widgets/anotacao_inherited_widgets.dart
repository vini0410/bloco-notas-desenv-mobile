...
class AnotacaoInheritedWidget extends InheritedWidget {
  ...
  static AnotacaoInheritedWidget of(BuildContext context) {
    return (context
            .dependOnInheritedWidgetOfExactType<AnotacaoInheritedWidget>()
        as AnotacaoInheritedWidget);
  }

  @override
  bool updateShouldNotify(AnotacaoInheritedWidget oldWidget) {
    return oldWidget.anotacoes != anotacoes;
  }
}
